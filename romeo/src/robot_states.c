...
/* Counters. */
COUNTER_DEFINE("/robot/counters/state_idle", robot_state_idle);
COUNTER_DEFINE("/robot/counters/state_starting", robot_state_starting);
COUNTER_DEFINE("/robot/counters/state_cutting", robot_state_cutting);
COUNTER_DEFINE("/robot/counters/state_searching_for_base_station", robot_state_searching_for_base_station);
COUNTER_DEFINE("/robot/counters/state_in_base_station", robot_state_in_base_station);

COUNTER_DEFINE("/robot/counters/cutting_state_forward", robot_cutting_state_forward);
COUNTER_DEFINE("/robot/counters/cutting_state_backwards", robot_cutting_state_backwards);
COUNTER_DEFINE("/robot/counters/cutting_state_rotating", robot_cutting_state_rotating);

COUNTER_DEFINE("/robot/counters/odometer", robot_odometer);

COUNTER_DEFINE("/robot/counters/is_stuck", robot_is_stuck);

COUNTER_DEFINE("/robot/counters/is_inside_perimeter_wire", robot_is_inside_perimeter_wire);
COUNTER_DEFINE("/robot/counters/is_outside_perimeter_wire", robot_is_outside_perimeter_wire);

/* Parameters. */
PARAMETER_DEFINE("/robot/parameters/charging", robot_parameter_charging, int, 0);
PARAMETER_DEFINE("/robot/parameters/search_for_the_base_station", robot_parameter_search_for_the_base_station, int, -1);
...
static int is_time_to_search_for_base_station(struct robot_t *robot_p)
{
    int search_for_the_base_station =
        PARAMETER(robot_parameter_search_for_the_base_station);
...
static int is_inside_perimeter_wire(float signal)
{
    ...
    if (is_inside == 1) {
        COUNTER_INC(robot_is_inside_perimeter_wire, 1);
    } else {
        COUNTER_INC(robot_is_outside_perimeter_wire, 1);
    }
...
{
    return (PARAMETER(robot_parameter_charging));
}
    ...
    *omega_p = 0.0f;
    ...
    if (is_time_to_search_for_base_station(robot_p)) {
        ...
        case CUTTING_STATE_FORWARD:
            COUNTER_INC(robot_cutting_state_forward, 1);
        ...
        case CUTTING_STATE_BACKWARDS:
            COUNTER_INC(robot_cutting_state_backwards, 1);
        ...
        case CUTTING_STATE_ROTATING:
            COUNTER_INC(robot_cutting_state_rotating, 1);
...
int robot_state_idle(struct robot_t *robot_p)
{
    ...
    COUNTER_INC(robot_state_idle, 1);
...
{
    COUNTER_INC(robot_state_starting, 1);
...
int robot_state_cutting(struct robot_t *robot_p)
{
    ...
    COUNTER_INC(robot_state_cutting, 1);
    ...
    if (speed > 0.0f) {
        COUNTER_INC(robot_odometer, speed * PROCESS_PERIOD_MS);
    }
...
int robot_state_searching_for_base_station(struct robot_t *robot_p)
{
    ...
    COUNTER_INC(robot_state_searching_for_base_station, 1);
...
{
    COUNTER_INC(robot_state_in_base_station, 1);
